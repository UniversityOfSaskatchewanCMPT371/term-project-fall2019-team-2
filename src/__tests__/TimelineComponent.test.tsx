...
describe('<TimelineComponent /> renders correctly', () => {
  const data = new Data('path/to/file', [
    {'Region': 'Sub-Saharan Africa', 'Country': 'Central African Republic',
      ...
      'index': 4535, 'Order Date_num': 1262325600000},
    {'Region': 'Asia', 'Country': 'China', 'Item Type': 'Cereal',
      'Sales Channel': 'Online',
      'Order Priority': 'C', 'Order Date': '1/1/2010',
    ...
    {'Region': 'Europe', 'Country': 'Sweden',
      ...
      'Total Cost': 279659.52, 'Total Profit': 573052.32,
    ...
    {'Region': 'Sub-Saharan Africa', 'Country': 'Equatorial Guinea',
      ...
      'Total Cost': 621472.32, 'Total Profit': 351682.92,
      'index': 7005, 'Order Date_num': 1262412000000},
    {'Region': 'Asia',
      'Country': 'Mongolia',
      'Item Type': 'Cosmetics', 'Sales Channel': 'Offline',
      ...
      'index': 9127, 'Order Date_num': 1262412000000}]);
